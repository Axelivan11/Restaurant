...
const Welcome = () => {
  return (
    <>
        <div className="flex flex-col items-center justify-center min-h-screen w-full bg-welcome bg-red-50 bg-center">
            <div className='form-welcome flex flex-col mx-8 items-center justify-center sm:w-[100vw] md:w-[80vw] lg:w-[80vw] xl:w-[30vw]'>
                <Lottie
