...
export default function Home(){
  return (
    ...
    <section className='flex justify-center mt-8 sm:mt-0 md:mt-8 lg:mt-0 xl:mt-0  mx-4 sm:mx-4 md:mx-8 lg:mx-32 xl:mx-32'>
        <div className="w-full max-w-5xl">
            <Carousel className="rounded-xl aspect-[26/9] overflow-hidden" autoplay={true} autoplayDelay={10000} loop={true} transition={{ duration: 3 }}>
            <img
    ...
    <section className='flex flex-wrap justify-center pt-8 mx-4 sm:mx-4 md:mx-8 lg:mx-32 xl:mx-32'>
        <div className="w-full text-[var(--color-red-950)]">
            <TabsMenu />
        </div>
    </section>
